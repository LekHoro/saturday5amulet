...
function GuidePromoCard({ lang, t }: { lang: Lang; t: Dict }) {
  ...
  return (
    <Link
      ...
      className="group mb-5 flex flex-col overflow-hidden rounded-2xl border border-gold/35 bg-gradient-to-r from-night-soft to-night transition hover:border-gold/60 sm:flex-row sm:items-center"
    >
      ...
      <div className="relative aspect-video w-full shrink-0 overflow-hidden bg-night sm:w-72 md:w-80">
        <Image
          src="/banners/kumanthong-guide-cover.jpg"
          alt=""
          fill
