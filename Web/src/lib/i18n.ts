...
const th = {
  ...
  home: {
    ...
    lagnara: {
      eyebrow: "ดูดวงกับอาจารย์เล็ก",
      title: "อยากรู้ดวงของตัวเอง ก่อนทำพิธี?",
  ...
  masters: {
    ...
    bannerAlt: (name: string) => `วัตถุมงคลของ${name}`,
    bioHeading: "ประวัติ",
  ...
  // แชทบอท "ผู้ช่วยเสาร์ห้า" (ChatWidget) — ปุ่มลอยเดียวแทนปุ่ม Line ลอยเดิม
  chat: {
    fabLabel: "ถามทางร้าน",
    fabAria: "เปิดแชทถามทางร้าน",
    title: "ผู้ช่วยเสาร์ห้า",
    subtitle: "ตอบอัตโนมัติจากข้อมูลในเว็บ",
    greeting:
      "สวัสดีค่ะ ผู้ช่วยเสาร์ห้าตอบจากข้อมูลในเว็บ เรื่องรุ่น ราคาบูชา วิธีบูชา และการจัดส่ง ถ้าเรื่องไหนต้องคุยกับคน กดปุ่ม \"คุยกับแอดมิน\" ด้านบนได้เลยค่ะ",
    chips: ["แนะนำรุ่นเสริมโชคลาภ ค้าขาย", "วิธีเลี้ยงกุมารทอง", "ส่งต่างประเทศได้ไหม", "สั่งบูชายังไง"],
    productChips: ["รุ่นนี้เหมาะกับใคร", "วิธีบูชารุ่นนี้", "มีองค์พร้อมส่งไหม"],
    placeholder: "พิมพ์คำถาม…",
    send: "ส่ง",
    close: "ปิดแชท",
    restart: "เริ่มใหม่",
    talkToAdmin: "คุยกับแอดมิน",
    adminGreeting: "สวัสดีค่ะ/ครับ ขอคุยกับแอดมิน",
    handoffTitle: "ส่งต่อให้แอดมิน",
    handoffHint: "กดปุ่มด้านล่าง ระบบจะเปิด LINE พร้อมสรุปนี้ ไม่ต้องเล่าใหม่",
    handoffButton: "ส่งสรุปนี้ไป LINE",
    adminHours: "แอดมินตอบแชท 10:00–22:00 น. ทุกวัน",
    viewProduct: "ดูรุ่นนี้",
    readArticle: "อ่านบทความ",
    viewMaster: "ดูประวัติ",
    openPage: "เปิดหน้านี้",
    orderLine: "สั่งบูชาผ่าน LINE",
    notifyLine: "แจ้งเมื่อมีเข้าใหม่",
    available: "พร้อมส่ง",
    soldOut: "หมดแล้ว",
    disclaimer: "เรื่องชำระเงิน ทางร้านแจ้งในแชท LINE ทางการเท่านั้น",
    typing: "ผู้ช่วยกำลังพิมพ์",
    error: "ขออภัยค่ะ ระบบขัดข้องชั่วคราว ทักแอดมินทาง LINE ได้เลยค่ะ",
    askAbout: "ถามผู้ช่วยเกี่ยวกับรุ่นนี้",
    askAboutShort: "ถามผู้ช่วย",
  },
...
const en: Dict = {
  ...
  home: {
    ...
    lagnara: {
      eyebrow: "Readings with Ajarn Lek",
      title: "Want to know your own chart before the ritual?",
  ...
  masters: {
    ...
    breadcrumb: "Masters",
    editions: (n: number) => `${n} ${n === 1 ? "edition" : "editions"}`,
    available: (n: number) => `${n} available`,
    totalEditions: (n: number) => `${n} ${n === 1 ? "edition" : "editions"} in total`,
    availableEditions: (n: number) => `${n} available`,
    videos: "Katha & ceremony videos",
    bannerAlt: (name: string) => `Amulets by ${name}`,
  ...
  chat: {
    fabLabel: "Ask the shop",
    fabAria: "Open chat to ask the shop",
    title: "Saturday5 Assistant",
    subtitle: "Automated answers from the website",
    greeting:
      "Hello! I'm the Saturday5 assistant. I answer from the website about editions, prices, how to worship and shipping. If you need a person, tap \"Talk to admin\" above.",
    chips: ["Recommend an edition for wealth and trade", "How to care for a Kumanthong", "Do you ship worldwide?", "How do I order?"],
    productChips: ["Who is this edition for?", "How to worship this edition", "Is it in stock?"],
    placeholder: "Type a question…",
    send: "Send",
    close: "Close chat",
    restart: "Start over",
    talkToAdmin: "Talk to admin",
    adminGreeting: "Hello! I'd like to talk to the admin.",
    handoffTitle: "Hand over to the admin",
    handoffHint: "Tap the button below to open LINE with this summary — no need to repeat yourself.",
    handoffButton: "Send this to LINE",
    adminHours: "The admin replies 10:00–22:00 Thailand time, every day",
    viewProduct: "View edition",
    readArticle: "Read article",
    viewMaster: "View master",
    openPage: "Open page",
    orderLine: "Order via LINE",
    notifyLine: "Notify me",
    available: "Available",
    soldOut: "Sold out",
    disclaimer: "Payment details are sent only in the official LINE chat",
    typing: "Assistant is typing",
    error: "Sorry, something went wrong. Please message the admin on LINE.",
    askAbout: "Ask the assistant about this edition",
    askAboutShort: "Ask the assistant",
  },
