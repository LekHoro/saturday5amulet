...
const en: Dict = {
  ...
  order: {
    ...
    metaDescription:
      "How to order amulets from Saturday5Amulet — message us on LINE with no obligation, confirm and pay in chat, fast delivery across Thailand and worldwide via DHL / EMS, worship guide and katha included.",
    ...
    assurances: [
      ...
      },
      {
        ...
        text: "Fast delivery across Thailand, and worldwide via DHL / EMS — tracking number sent in chat as soon as it ships.",
      },
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes — we ship worldwide via DHL / EMS. Tell us your country in chat and we'll check the shipping cost before you decide.",
      },
    ] as { q: string; a: string; link?: { href: string; label: string } }[],
